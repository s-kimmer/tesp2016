...
def draw():
    ...
    if player.health >= 90:
        drawText('healTh: %a shielD: %a'% (round(player.health), player.shield), astroFont, 5, 5, WHITE)
    elif player.health >= 60 and player.health < 90:
        drawText('healTh: %a shielD: %a'% (round(player.health), player.shield), astroFont, 5, 5, GREEN)
    elif player.health >= 40 and player.health < 60:
        drawText('healTh: %a shielD: %a'% (round(player.health), player.shield), astroFont, 5, 5, YELLOW)
    else: # player.health >= 0 and player.health < 40:
        drawText('healTh: %a shielD: %a'% (round(player.health), player.shield), astroFont, 5, 5, RED)
    ##########################
